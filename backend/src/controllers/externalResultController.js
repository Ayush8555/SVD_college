...
export const fetchExternalResult = async (req, res) => {
    ...
    try {
        ...
        // 1b. POST credentials
        const postUrl = 'https://vbspuresult.org.in/Home/SemesterResult?SemesterType=Odd&Session=2025-26';
        const formData = new URLSearchParams();
        formData.append('RollNo', rollNo);
        formData.append('Password', dob);
        formData.append('Captcha', '123'); // Send dummy captcha as server might check its presence
