...
import FeeExtensionRequests from '../components/admin/FeeExtensionRequests';
...
const AdminDashboard = () => {
  ...
  const menuItems = [
      ...
      { id: 'fee-extensions', label: 'Fee Extensions', iconType: 'calendar' },
      ...
      <div className="flex-1 flex flex-col min-h-screen md:ml-64 transition-all duration-300">
        ...
        <main className="flex-1 bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {activeTab === 'fee-extensions' && <FeeExtensionRequests />}
