...
export const feeAPI = {
  ...
  getRecentAssignments: (params) => api.get('/fees/recent-assignments', { params }),
  searchStudents: (params) => api.get('/fees/students/search', { params }),
  getStudentRecords: (params) => api.get('/fees/student-records', { params }),
  assignFeeSingle: (data) => api.post('/fees/assign-single', data),
};
